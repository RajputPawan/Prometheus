...
Starting with Ubuntu Jammy, the ROS project decided to no longer provide packages for *ROS1* as they encourage to switch to *ROS2*. As ROS2 is not a simple update but includes major changes to the environment, currently *no* ROS packages from the ros.org are available for Jammy on the Ubunturd repo server.
...
* Use the self-service tool on your device *reinstall-os.sh*.
...
**MS Teams Support Channel (Free Subscription): [Click me](https://social.cloud.corpintra.net/external-link.jspa?url=https%3A%2F%2Fteams.microsoft.com%2Fl%2Fchannel%2F19%253a98e89971b7044a56b696cdb9555f4fe5%2540thread.tacv2%2FUpgrade%252520Support%3FgroupId%3D13fe2da7-5cab-4525-9f67-b54eefb7a8ca%26tenantId%3D9652d7c2-1ccf-4940-8151-4a92bd474ed0)**
